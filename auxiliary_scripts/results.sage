...
chosen_inputs_category=['integer', 'integer', 'complex', 'complex', 'complex', 'integer', 'integer', 'complex', 'complex', 'complex', 'complex', 'complex', 'integer', 'integer', 'complex', 'integer', 'complex', 'complex', 'complex', None, 'integer', 'integer', 'integer', 'integer', 'complex', 'complex', 'integer', 'integer', 'integer', 'integer', 'integer', 'complex', 'integer', 'complex', 'complex', 'cubic', 'cubic', 'cubic', 'cubic']
...
rows=[]
category='integer'#'cubic' #'complex'
