...
methods_phase1=[None]        #methods in the list are used. If empty, default method is used.
max_input_length = 10    #maximal length of the input of the weight function
methods_phase2=[4]        #methods in the list are used. If empty, default method is used.
