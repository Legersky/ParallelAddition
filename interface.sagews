...
def _(frame_label=text_control('<h3>Find weight function: </h3>', label=''),
    ...
    if 1:
        ...
        print " "
        start=time.clock()
        alg.findWeightFunction(max_iterations,max_input_len, method_weightCoefSet=3, method_weightFunSearch=4)
        end=time.clock()
...
︠52f6e566-beff-43ac-9747-bfe6232971cf︠
